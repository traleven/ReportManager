...
namespace ReportManager.Controls
{
	...
	/// </summary>
	[Serializable()]
	public class STextBox : System.Windows.Forms.TextBox,
		...
		System.Xml.Serialization.IXmlSerializable
	{
		...
		public STextBox(System.Runtime.Serialization.SerializationInfo info, 
			System.Runtime.Serialization.StreamingContext context):base()
		{
			...
			this.TextAlign = (HorizontalAlignment)info.GetValue("TextAlign",
		...
		public void Draw(System.Drawing.Graphics e)
		{
			if(this.TextAlign == HorizontalAlignment.Left)
				...
				if(this.TextAlign == HorizontalAlignment.Right)
					e.DrawString(this.Text,this.Font,new SolidBrush(this.ForeColor),
						(System.Drawing.PointF)new Point(
						Parent.Location.X+Location.X+100+Width - Convert.ToInt32(
						e.MeasureString(Text,Font).Width),
						((int)((Parent.Location.Y+Location.Y)*Report.PageScaleY))%Report.PageHeight+100));
		}

		public System.Windows.Forms.Control Clone()
		{
			STextBox t = new STextBox();
		...
		public void ReadXml(System.Xml.XmlReader reader)
		{
			...
			if(s!=null)
				TextAlign = (HorizontalAlignment)Int32.Parse(s);
			{
				string fName = null;
				float fSize = 10;
				FontStyle fStyle = 0;
